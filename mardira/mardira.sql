...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 01 Agu 2022 pada 08.08
...
(4, 171234567, 'Asep Mulyono', 1),
(5, 1711234568, 'Dani Septiono', 1),
(6, 1711234569, 'Haryono Hasan', 2),
(9, 12345671, 'Ahmad Yusup', 2);
...
--
ALTER TABLE `mahasiswa`
  MODIFY `id_mahasiswa` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
